...
def data():
    ...
    link_sep_on = True  # or False, depends on your implementation
    link_option2_on = True  # or False, depends on your implementation

    prop_lst, geom_lst, geojson_geom_list = con(link_option, link_cls, link_sep, link_sep_on, link_option2, link_option2_on, link_cls2, link_sep2_on, out_day, like_length, weight_hot, weight_serve, weight_dem, weight_weather)
    return jsonify(geojson_geom_list)  


def con(link_option, link_cls, link_sep, link_sep_on, link_option2, link_option2_on, link_cls2, link_sep2_on, out_day, like_length, weight_hot, weight_serve, weight_dem, weight_weather):
