...
const mapStateToProps = (state) => ({
  setpath_hot: state.trajReducer.setpath_hot,
  setpath_service: state.trajReducer.setpath_service,
  setpath_challenge: state.trajReducer.setpath_challenge,
  setpath_weather: state.trajReducer.setpath_weather,
});
