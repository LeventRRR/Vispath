...
export default function trajReducer(preState = initState, action) {
    ...
    switch (type) {
        ...
        case 'set_path_values':
            return {...preState,
                    setpath_min: data.min,
                    setpath_max: data.max,
                    setHistory: [...preState.setHistory, 
                                 {type: 'setpath_min', value: data.min},
                                 {type: 'setpath_max', value: data.max}]
            }
        case 'setpath_hot':
            return {...preState, 
                setpath_hot: data,
