...
def data():
    ...
    for key, value in data.items():
        ...
        print(request.data)
    # 从data中提取值
    link_option = data['setlandscape_type']
    link_cls = data['setlandscape_compact']
    link_sep = data['setlandscape_loose']
    link_option2 = data['setdemand_type']
    link_cls2 = data['setdemand_compact']
    link_sep2 = data['setdemand_loose']
    out_day = data['settrip_time']
    out_way = data['settrip_type']
    like_length = (data['setpath_min'], data['setpath_max'])
    weight_hot = data['setpath_hot']
    weight_serve = data['setpath_service']
    weight_dem = data['setpath_challenge']
    weight_weather = data['setpath_weather']
    # 检查值是否被正确传入
