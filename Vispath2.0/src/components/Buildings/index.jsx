...
*/
export default function Build({data = DATA_URL, mapStyle = MAP_STYLE}) {
  ...
  return (
    ...
    >
      <Map reuseMaps mapLib={maplibregl} mapStyle={mapStyle} preventStyleDiffing={true} className="build-container" />
    </DeckGL>
  );
}
